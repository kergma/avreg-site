...
//                        'mov':'vlc'
    ...
    play: function (element, settings) {
        var $element = $(element),
            $wrappingElement = settings.hasExtraWrapper ? $element.parents('.pl_wrapper') : $element;
        ...
        if (sets.height.indexOf('Inherit') != -1) {
            ...
            sets.height = $wrappingElement.height();
        }
        if (sets.width.indexOf('Inherit') != -1) {
            // необходимо не 0 значение для IE для инициализации ActiveX объекта
            sets.width = $wrappingElement.width();
        }
