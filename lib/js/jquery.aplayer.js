...
//            	console.log(e);
            ...
            if ($('#'+ $.aplayer.idContainer + settings.nr).aplayerIsHTML5_Video() ||
                $('#'+ $.aplayer.idContainer + settings.nr).aplayerIsHTML5_Audio()){
                $.aplayer.ControlBar.elMediaOnCanPlay(settings.nr);
            }
