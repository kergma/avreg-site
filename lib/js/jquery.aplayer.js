...
/*            	var rtspPort = "554";
            	if (imagepath.indexOf("://") == -1) {
            		if (location.hostname.split(":").length > 1) {
            			//IPv6
            			MediaURL = "rtsp://[" + location.hostname + "]:" + rtspPort + imagepath ;
            	    } else {
            	        //IPv4
            	        MediaURL = "rtsp://" + location.hostname + ":" + rtspPort + imagepath ;
            	    }
            	...
            	// <?php 	echo 'rtsptextrtsp://dummyurl/'.$_GET['path']; ?>
            	// пример MediaURL="rtsp://axis1031:554/axis-media/media.amp?videocodec=mpeg4"
*/
            	var output = "";
            	...
            	output += '<param name="src" value="http://localhost:8000/view/AxisMoviePoster.mov">';
            	output += '<param name="autoplay" value="'+Autostart+'">';
            	output += '<param name="controller" value="' + ShowAMCToolbar+ '">';
            	output += '<param name="qtsrc" value="' + MediaURL + '">';
            	output += '<embed src="http://localhost/view/AxisMoviePoster.mov" width='+ DisplayWidth + 
            		' height=' + DisplayHeight + ' qtsrc="' + MediaURL + '" autoplay="'+Autostart+
            		'" controller="' + ShowAMCToolbar + '" target="myself" PLUGINSPAGE="http://www.apple.com/quicktime/download/"></embed>';
            	output += '</OBJECT>';
