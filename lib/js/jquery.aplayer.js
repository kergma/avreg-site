		...
		versionPredicate : function(f,s){
			...
			play : function(element, settings){
				...
				else if(sets.logoPlay != undefined && (sets.logoPlay.indexOf('true')!=-1 )) 
				{
                    ...
                    //s= '/bbb-800.mp4';
                    //@TODO ТЕстовые ролики для html5-video
                    //s = 'http://easyhtml5video.com/images/happyfit2.ogv';
                    //s = '/123.ogv';
                    //s = 'http://www.808.dk/pics/video/gizmo.ogv';
                    //s = 'http://upload.wikimedia.org/wikipedia/commons/transcoded/1/14/Xacti-AC8EX-Sample_video-001.ogg/Xacti-AC8EX-Sample_video-001.ogg.480p.webm';

                    /**
                    var sourceOgg = {
                        0 : '/Test_avi.ogv.360p.webm',
                        1 : '/VfE.ogv',
                        2 : '/html5-video-element-test.ogg',
                        3 : '/Ivy_Mike_test.ogg.360p.webm',
                        4 : '/happyfit2.ogv',
                        5 : '/123.ogv',
                        6 : '/HD1_1.ogv',
                        7 : '/SD.ogv',
                    ...
                    if (sourceOgg[cntVideo] !== undefined){
                        s = sourceOgg[cntVideo];
                    }
                    cntVideo++;
			...
			showMjpeg : function(container, settings){
				...
				if(settings.controls==false || settings.controls=='off' ){console.log('asdsad');
