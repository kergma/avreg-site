		...
		versionPredicate : function(f,s){
			...
			showVLC : function(container, settings){
            	...
            	if($.browser.msie){
            		...
            		html = '<OBJECT classid="clsid:E23FE9C6-778E-49D4-B537-38FCDE4887D8" codebase="http://downloads.videolan.org/pub/videolan/vlc/0.8.2/win32/axvlc.cab" ';
...
//						console.log(error.message);
		...
		setControls : function(container, settings)
		{
			...
			var CurrentTime = $('<div>' + time[0] + '</div>')
				...
				.css($.aplayer.ControlBar.TimeFontStyle).css('margin-left', '7px');
