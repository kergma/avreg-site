...
//---------------------------------------------------- Player ------------------------------------
    ...
    $.fn.aplayerResizeToParent = function () {
	    ...
	    $(Cont).find('object, embed, img').each(function () {
	    	if($(this).hasClass('cntr_img')) {} //чтобы избежать ресайза изображений контролов
            else{
        ...
        .height(function(){
                var $container = $(Cont),
                    $parent = $container.parents(".win");

                return $container.height()-$(this).next('div[id ^=' + $.aplayer.idControlPanel + ']').height() - $parent.find('.ptz_area_bottom').height();
        })
        .end()
        .find('.MediaCont')
	...
	$.aplayer = {
         ...
         * @param {Boolean} show
         */
        togglePtzAreas: function (aplayerID, show) {
            var $player = $('#'+aplayerID),
                $win = $player.parents('.win');

            if (show) {
                $win.find('.ptz_area_bottom, .ptz_area_right').show();
