...
//---------------------------------------------------- Player ------------------------------------
    ...
    $.fn.aplayerResizeToParent = function () {
        $(this).children('div[id ^=' + $.aplayer.idContainer + ']').each(function () {
            var h_cont = $(this).parents('.pl_wrapper').height() - 2;
            var w_cont = $(this).parents('.pl_wrapper').width() - 2;
            ...
            $cont.find('object, embed, img').each(function () {
                ...
                .height(function () {
                    var $container = $cont;
                    return $container.height() - $(this).next('div[id ^=' + $.aplayer.idControlPanel + ']').height();
                })
                .end()
                .find('.MediaCont')
