...
class OnvifClient
{
	 ...
	 */
	function __construct($serviceLocation, $wsdlLocation, $options = array())
	{
	...
	private function makeToken()
	{
		...
		return $this->passwordDigest($this->credentials['username'], $this->credentials['password'], date('Y-m-d\TH:i:s.000\Z', $timestamp));
	}
