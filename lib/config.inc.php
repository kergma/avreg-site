...
foreach ($result as $row  )
{
   ...
   $ui['MAX_MEDIA_SESSION_RATE_KB'] = is_null($row['MAX_MEDIA_SESSION_RATE_KB'])?NULL:(int)$row['MAX_MEDIA_SESSION_RATE_KB'];
   $ui['MAX_MEDIA_SESSION_MINUTES'] = is_null($row['MAX_MEDIA_SESSION_MINUTES'])?NULL:(int)$row['MAX_MEDIA_SESSION_MINUTES'];
