/**
 * @file offline/gallery/js/main.js
 * @brief Ключевой JS скрипт реализующий функциональность галереи
 * 
 * Реализует:
 * <ul>
 * <li> Инициализация и установка элементов галереи
 * <li> Навигация по галерее
 * <li>	Фильтры отображения содержимого галереи
 * <li> Изменение масштаба просмотра
 * <li> Режим предварительного просмотра
 * <li> Режим детального просмотра  и т.п.
 * </ul>
 */
