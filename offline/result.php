    ...
    if ($num_rows > 0) {
        ...
        for ($p_count = 0; $p_count < $num_rows; $p_count++) {
            ...
            if ($CAM_NR !== 0) {
                ...
                /* _cam_nr, _evt_id, _utime1, _utime2, _ser_nr, _fsize,
                _frames, _u16_1, _u16_2, _ftype_str, _fduration, _fname */
            ...
            if ($CAM_NR !== 0) {
                if ($EVT_ID === 23 /*video avi*/) {
                    print '<td valign="middle"><a name="video" href="javascript:mark_row(' . $good_link .
                        ');"><img id="' . $EVT_ID . '" src="' . $conf['prefix'] .
                        '/img/movie.gif" width="20" height="22" border="0" name="' . $for_js .
                        '" onmouseover="mouse_img (' . $good_link . ');" onmouseout="mouse_img();"></a></td>' . "\n";
                    $good_link++;
                } elseif ($EVT_ID === 32 /*audio*/) {
                    print '<td valign="middle"><a name="audio" href="javascript:mark_row(' . $good_link .
                        ');"><img id="' . $EVT_ID . '" src="' . $conf['prefix'] .
                        '/img/audio-off.gif" width="20" height="22" border="0" name="' . $for_js .
                        '" onmouseover="mouse_img (' . $good_link . ');" onmouseout="mouse_img();"></a></td>' . "\n";
                    $good_link++;
                } elseif ($EVT_ID >= 15 && $EVT_ID <= 17 /* snapshot jpegs */) {
                    print '<td valign="middle"><a name="jpeg" href="javascript:mark_row(' . $good_link
                        . ');"><img id="' . $EVT_ID . '" src="' . $conf['prefix'] .
                        '/img/camera.gif" width="22" height="22" border="0" name="' . $for_js .
                        '" onmouseover="mouse_img (' . $good_link . ');" onmouseout="mouse_img();"></a></td>' . "\n";
                    $good_link++;
            ...
            if ($EVT_ID === 23 || $EVT_ID === 32) {
                ...
                print '<td class="small_text">' . $ftype_str . '&nbsp;(' . $f_ext . ', ' .
                    $f_duration_str . ')</td>' . "\n";
            } elseif ($EVT_ID >= 15 && $EVT_ID <= 17 /* snapshot jpegs */) {
