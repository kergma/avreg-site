...
//		msgSystem.startLoading('Loading results...');
	},
	error: function (XMLHttpRequest, textStatus, errorThrown) {
//		console.info('ajax error: ' + textStatus);
//		if(textStatus != null && XMLHttpRequest.status != 405){
//			msgSystem.message('Произошла ошибка сервера ('+XMLHttpRequest.status+' '+errorThrown+')');
//		}
	},
