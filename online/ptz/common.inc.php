...
include($cam_http_params['ptz'].'.php');
...
if (!empty($_REQUEST['get']))
{
	...
	if (preg_grep('/_bounds$/',$g) and function_exists('get_cam_bounds')) $r=get_cam_bounds($url);
	...
	if (array_intersect(array('pan','tilt','zoom','focus'),$g) and function_exists('get_cam_pos')) $r=get_cam_pos($url);
...
$(function() {
	...
	$.get('ptz/common.inc.php',{cam_nr:$cam_nr,get:'ptzf_bounds,ptzf'},function(data){
