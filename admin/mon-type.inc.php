...
function layout2table($mon_type, $max_width, $win_text_array = array(), $win_text = '')
{
    ...
    if (empty($max_width)) {
        ...
        $t_start_1 = '<td width="' . $win . '" height="' . $h . '" align="center" valign="middle" bgcolor="' . $bgcol
            . '"><font color="white"><b>&nbsp;';
        $t_start_2 = '<td width="' . $w2 . '" height="' . $h2 . '" align="center" valign="middle" bgcolor="' . $bgcol
            . '"><font color="white"><b>&nbsp;';
        $t_start_3 = '<td width="' . $w3 . '" height="' . $h3 . '" align="center" valign="middle" bgcolor="' . $bgcol
            . '"><font color="white"><b>&nbsp;';
        $t_start_4 = '<td width="' . $w4 . '" height="' . $h4 . '" align="center" valign="middle" bgcolor="' . $bgcol
            . '"><font color="white"><b>&nbsp;';
        $t_start_5 = '<td width="' . $w5 . '" height="' . $h5 . '" align="center" valign="middle" bgcolor="' . $bgcol
            . '"><font color="white"><b>&nbsp;';
    }
    ...
    for ($win = 0; $win < $count_camers_in_layout; $win++) {
        ...
        if ($colspan > 1 || $rowspan > 1) {
            print "<$e $sz id=\"win_$win\" class=\"layout\" colspan=\"$colspan\" rowspan=\"$rowspan\"
            align=\"center\" valign=\"middle\">$text_in_win</$e>\n";
        } else {
