...
<tr>
	<td><?php show_mon_type ( 'ONECAM', 128, $wins ); ?></td>
	<td><?php show_mon_type ( 'QUAD_4_4', 128, $wins ); ?></td>
	<td><?php show_mon_type ( 'MULTI_6_9', 128, $wins ); ?></td>
	<td><?php show_mon_type ( 'MULTI_7_16', 128, $wins ); ?></td>
	<td><?php show_mon_type ( 'MULTI_8_16', 128, $wins ); ?></td>
<tr bgcolor="#f4f0f4">
