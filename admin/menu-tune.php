...
if ( isset($tab) && ($tab == 'arch'))
print '<div class="menu0active">-&nbsp;<a  href="'.$conf['prefix'].'/admin/menu-tune.php?tab=arch&#038;load='.$conf['prefix'].'/admin/archive.php" target="menu">'.$left_archive.'</a></div>'."\n";
else
print '<div class="menu0">+&nbsp;<a href="'.$conf['prefix'].'/admin/menu-tune.php?tab=arch&#038;load='.$conf['prefix'].'/admin/archive.php" target="menu">'.$left_archive.'</a></div>'."\n";
}
