...
print '<td><input type="checkbox" name="guest" ' . ((isset($guest) && $guest) ? 'checked' : '') . '>'
    . $strGuestMode . "\n";
print '</tr>' . "\n";
...
print '<td><input type="text" name="u_layouts" size="40" maxlength="100" value="'
    . (isset($u_layouts) ? $u_layouts : '') . '">' . "\n";
print '</tr>' . "\n";

print '<tr>' . "\n";
print '<td colspan="2">' . $strForcedSavingLimit . '</td>' . "\n";
print '<td><input type="text" name="u_forced_saving_limit" size="4" maxlength="4" value="'
    . $u_forced_saving_limit . '">' . "\n";
print '</tr>' . "\n";
print '<tr>' . "\n";
print '<td colspan="2">' . $SessionsPerUserInfo . '</td>' . "\n";
