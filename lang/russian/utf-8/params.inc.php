...
array(
   ...
   'type'    => $STRING200_VAL,
   'def_val' => NULL,
   'desc'    => '<b>Прямой URL веб-интерфейса ip-камеры</b>.
   <br><br>Значение этого параметра будет подставленно в виде ссылки в заголовке окна камеры на странице просмотра в реальном времени для пользователей все групп, исключая группу &#171;Только просмотр&#187;. Ссылка предназначена для прямого перехода в веб-интерфейс сетевой камеры (откроется в новом окне) со страницы просмотра в реальном времени веб-интерфейса AVReg.
