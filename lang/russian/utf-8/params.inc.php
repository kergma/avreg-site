...
<p><b>Скорость захвата с мультиплексируемых камер</b> (к одному видеодекодеру BT878/SAA71xx/CX2388x подключена более чем 1 камера) в теории равна примерно 12/(1+skip_frames). Однако на практике, в системах без использования единой внешней системы синхронизации камер (например, от переменки 24В), для устранения артефактов,
