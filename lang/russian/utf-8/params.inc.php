...
<br><br>Поддерживаются такие события, как:
<ul>
...
<p>
Кроме установки параметра &#171;<span class="param">events2pipe</span>&#187; в &#171;Вкл.&#187;, вы должны иметь исполняемый скрипт в каталоге &#171;<span class="path">/etc/avreg/scripts/</span>&#187; и прописать полный путь до него в конфигурационном файле &#171;<span class="path">avreg.conf</span>&#187; в параметре &#171;<span class="param">event-collector</span>&#187;.
</p>
<p>
Скрипты могут быть написаны на любом языке программирования (shell, python, perl, ruby, php, java и т.п., даже на С).
</p>
<p>
