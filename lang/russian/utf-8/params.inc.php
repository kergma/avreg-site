...
array(
  ...
  'type'    => $INT_VAL,
  'def_val' => 3,
  'desc'    => '<b>Предзапись</b>. Будет также записано это количество &quot;спокойных&quot; кадров, захваченных перед КАЖДЫМ кадром, на котором сработал детектор движения. <b>Существенно увеличивает требование к объёму оперативной памяти</b>.<p>Доступно только при выборочном режиме записи (<em>save_video</em>=&laquo;Выборочный&raquo;) и включенном детекторе движения (<em>motion_detector</em>=&laquo;Вкл.&raquo;).</p>Допустимые значения: [0..125]. По умолчанию: <b>3 кадра</b>.',
  'flags'   => $F_IN_DEF | $F_IN_CAM,
  'cats'    => '11.1',
  'subcats' => NULL,
  'mstatus' => 2,
...
array(
  ...
  'type'    => $INT_VAL,
  'def_val' => 3,
  'desc'    => '<b>Послезапись</b>.Будет также записано это количество &quot;спокойных&quot; кадров, захваченных после КАЖДОГО кадра, на котором сработал детектор движения.<p>Доступно только при выборочном режиме записи (<em>save_video</em>=&laquo;Выборочный&raquo;) и включенном детекторе движения (<em>motion_detector</em>=&laquo;Вкл.&raquo;).</p>Допустимые значения: [0..250]. По умолчанию: <b>3 кадра</b>.',
  'flags'   => $F_RELOADED | $F_IN_DEF | $F_IN_CAM,
  'cats'    => '11.1',
  'subcats' => NULL,
  'mstatus' => 2,
