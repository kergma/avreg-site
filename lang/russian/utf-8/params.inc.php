...
<p><b>Скорость захвата с немультиплексируемых камер</b> (к одному видеодекодеру BT878/SAA7134/CX2388x подключена только 1 камера) будет равна <b>25/(1+skip_frames)</b>.
Т.е. skip_frames=0 - fps=25, skip_frames=2 - fps=12, skip_frames=3 - fps=6, и т.д.</p>
<p><b>Скорость захвата с мультиплексируемых камер</b> (к одному видеодекодеру BT878/SAA7134/CX2388x подключены более чем 1 камеры) в теории равна примерно 12/(1+skip_frames). Однако на практике, в системах без использования единой внешней системы синхронизации камер (например, от переменки 24В), для устранения артефактов,
...
array(
  ...
  'type'    => 'BOOL',
  'def_val' => 1,
  'desc'    => '<b>Фильтрация</b> эффектов <b>быстрого кратковременного дрожания</b> в кадре <b>при мультиплексировании каналов</b> (когда к одному видеодекодеру  BT878/SAA7134/CX2388x подключено сразу несколько камер). Для сетевых видеокамер не используется.<br><br>По умолчанию: <b>Вкл</b>.',
  'flags'=>$F_IN_DEF | $F_IN_CAM,
  'cats'    => '5.1.3',
  'subcats' => NULL,
  'mstatus' => 2,
