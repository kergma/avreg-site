...
Примечания:
<ul>
<li>&laquo;cam_type=netcam&raquo; - настройка скорости отдачи потокового (MJPEG, MPEG4) видеозахвата регулируется настройками самих ip-камер/видеосерверов, а в продвинутых моделях может указываться в параметрах запроса к устройствам (например, <nobr>V.http_get=/axis-cgi/mjpg/video.cgi?fps=15</nobr>).</li>
<li>&laquo;cam_type=v4l&raquo; - при использовании video4linux PCI плат, скорость захвата ограничивается используемым телевизионным стандартом и количеством видеокамер, подключенных к одному видеокодеру (устройству video4linux, параметр v4l_dev):
<ul>
<li>1 камера на 1 устройстве - 25fps(PAL)/30fps(NTSC),</li>
<li>2 камеры - 5-6 fps,</li>
<li>3 камеры - 3-4 fps,</li>
<li>4 камеры - 2 fps</li>
</ul>
</ul>
