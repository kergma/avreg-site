...
$recording_format   = array('mp4', 'flv', 'ogg',  'avi', 'mov', 'matroska', 'wav', 'amr');
$rec_vcodec         = array('mpeg4', 'flv', 'mjpeg', 'h263p');
$rec_acodec         = array('aac', 'vorbis', 'adpcm', 'pcm', 'libgsm', 'libopencore_amrnb');
...
array(
   ...
   'type'    => $STRING200_VAL,
   'def_val' => NULL,
   'desc'    => '<b>Альтернативные источники видео (минуя avregd)</b> для конфигурирования раскладок просмотра веб-браузерами.<br><br>Альтернативный <b>URL #1</b> для камеры в раскладке.<br><br>Например: rtsp://axis-ip/axis-media/media.amp?resolution=320x240&videocodec=h264&audio=0<br><br>По умолчанию: не установлено (получать видео от avregd)',
   'flags'   => $F_RELOADED | $F_IN_CAM,
   'cats'    => '15.2',
   'subcats' => NULL,
   'mstatus' => 1,
