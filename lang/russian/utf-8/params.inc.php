...
array(
  ...
  'type'    => 'INT',
  'def_val' => 5,
  'desc'    => '<b>Макс. допустимое количество логических ошибок в протоколе.</b>.<br />Диапазон: [2..10], по умолчанию: &quot;<b>5 сек.</b>&quot;.',
  'flags'=>$F_RELOADED | $F_IN_DEF | $F_IN_CAM,
  'cats'    => '3.1.1',
  'subcats' => NULL,
  'mstatus' => 2,
...
array(
  ...
  'type'    => 'CHECK',
  'def_val' => NULL,
  'desc'    => 'Создать <b>виртуальный видеоканал</b>, на который будет <b>транслироваться видео</b> с этой камеры для программы <b>mon</b>.<br><br><b>Нужно назначать последовательно без совпадений.</b><br><br>По умолчанию: <b>не определено</b> - значит <b>локальный просмотр</b> с программы <b>mon</b> для данной камеры <b>не возможен</b>.',
  'flags'=>$F_RELOADED | $F_BASEPAR | $F_IN_DEF | $F_IN_CAM,
  'cats'    => '15.1',
  'subcats' => NULL,
  'mstatus' => 2,
