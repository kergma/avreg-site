...
<ul><li><b>Для камер, подключенных через платы видеозахвата,</b> установите пропорционально разрешающей способности видеокамеры с учётом требуемого качества и ресурсов сервера. Для ВСЕХ каналов ОДНОГО устройства видеозахвата (более точно чипа-декодера) должно быть ОДНО значение:<br><b>384x288, 480x360, 560x420, 640x480, 720x540, 768x576</b>.</li><li><b>Для сетевых</b> камер выберите из списка размеры изображения <b>которое реально выдает ip-камера</b> или видеосервер. Если вы не нашли в нашем списке нужного разрешения, сообщите нам.</li></ul>По умолчанию: <b>384x288</b>.',
  'flags'=>$F_BASEPAR | $F_IN_DEF | $F_IN_CAM,
  'cats'    => '3',
  'subcats' => '3.1;3.2',
  'mstatus' => 2,
...
array(
  ...
  'type'    => 'INT',
  'def_val' => 7,
  'desc'    => '<b>Скорость воспроизведения</b> - частота кадров в сек (!!! для ПРОСМОТРА, не для записи) <b>видеофильмов AVI</b>, сжатых кодеками MPEG4, MJPEG. Рекомендуется устанавливать равной реальной скорости захвата с видеокамеры или несколько больше.<br><br>Допустимые значения: 1..30. По умолчанию: <b>7 кадров/сек</b>.',
  'flags'=>$F_RELOADED | $F_BASEPAR | $F_IN_DEF | $F_IN_CAM,
  'cats'    => '11.1',
  'subcats' => NULL,
  'mstatus' => 2,
...
array(
  ...
  'type'    => 'INT',
  'def_val' => 2,
  'desc'    => '<strong>Максимальное кол-во</strong> подключенных сетевых <strong>клиентов</strong> в одно время <strong>для этой камеры</strong>.<br>Устанавливайте разумные значения с учётом реальных максимального количества пользователей и ренсурсов сервера и сетевого оборудования. Иначе возможны аварийный останов или даже крах демона &#171;'.$conf['daemon-name'].'&#187;.<br><br>Допустимые значения от 1 до 1000. По умолчанию: <b>3</b>.',
  'flags'=>$F_RELOADED | $F_IN_DEF | $F_IN_CAM,
  'cats'    => '15.2',
  'subcats' => NULL,
  'mstatus' => 2,
