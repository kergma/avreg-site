...
$strOnlySelDet='Доступно <i>только при выборочном режиме записи</i> (<i>continuous_record</i>=&laquo;Выкл.&raquo;) и включенном детекторе движения (<em>motion_detector</em>=&laquo;Вкл.&raquo;).';
...
array(
  ...
  'type'    => $BOOL_VAL,
  'def_val' => true,
  'desc'    => '<b>Записывать видеокадров на жесткие диски (HDD)</b>?
<p>По умолчанию: &#171;<b>Вкл.</b>&#187; - записывать.',
  'flags'   => $F_BASEPAR | $F_IN_DEF | $F_IN_CAM,
  'cats'    => '11',
  'subcats' => NULL,
  'mstatus' => 2,
...
array(
  ...
  'type'    => $BOOL_VAL,
  'def_val' => true,
  'desc'    => '<b>Записывать аудио на жесткие диски (HDD)</b>?
<p>По умолчанию: &#171;<b>Вкл.</b>&#187; - записывать.',
  'flags'   => $F_BASEPAR | $F_IN_DEF | $F_IN_CAM,
  'cats'    => '11',
  'subcats' => NULL,
...
array(
  ...
  'type'    => $BOOL_VAL,
  'def_val' => false,
  'desc'    => '<b>&#171;Сплошной&#187; (непрерывный, безусловный) режим записи</b>, при котором <i>всегда и абсолютно все</i> захваченные с устройств видео-кадры и аудио-фреймы записываются на диск.
<p>Кроме &#171;сплошного&#187; режима есть &#171;<b>выборочный</b>&#187; (по-умолчанию) режим, при котором запись управляется событиями <i>любых</i> из следующих подсистем:</p>
<ol>
<li>детектор движения;</li>
<li>детектор звука (пока не реализовано);</li>
<li>avregd CGI-интерфейс (внешние команды).</li>
</li></ol>
<p>По умолчанию: &#171;<b>Выкл.&#187;  - т.е. &#171;выборочный&#187;</b>.</p>',
  'flags'   => $F_BASEPAR | $F_IN_DEF | $F_IN_CAM,
  'cats'    => '11',
  'subcats' => NULL,
  'mstatus' => 1,
