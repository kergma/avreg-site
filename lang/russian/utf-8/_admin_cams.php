...
<li>Для обеспечения максимальной производительности и возможности просмотра более 6 камер одновременно некоторыми современными браузерами <a href="http://avreg.net/manual_applications_smp.html" target="_blank">разделите камеры на группы не более чем 6 в каждой</a>.</li>
</ul>';
