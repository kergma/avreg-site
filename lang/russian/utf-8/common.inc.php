...
$strAdvice = 'Совет';
$strAdvices = 'Советы';
$fmtTryOnceMore = 'Для повторной попытки входа, перезапустите браузер (закройте все окна) и попробуйте ещё раз<br />или же обратитесь к администратору сервера %s';
...
2=>array('grname'=>'Администраторы','grdesc'=>'Почти полный доступ за исключением добавления/удаления камер и изменения большинства специфических настроек камер.'),
3=>array('grname'=>'Операторы архива','grdesc'=>'Mогут просматривать архив и наблюдать за камерами в реальном времени'),
4=>array('grname'=>'Операторы наблюдения','grdesc'=>'Mогут наблюдать за камерами в реальном времени и управлять ими (вкл./выкл. режима принудительной записи, PTZ).'),
...
$web_left_monitors_desc = 'Раскладки (планы просмотра) для наблюдения за камерами в реальном времени в веб-браузерах c';

$no_any_layout = 'Нет сконфигурированных раскладок';
$r_mons = $left_monitors_desc.' видеосервера  &#171;%s&#187; [%s].';
$web_r_mons = $web_left_monitors_desc.' видеосервера  &#171;%s&#187; [%s].';
...
$web_r_mon_changed = 'Раскладка #%d [%s] для %s монитора успешно изменена.<br />Обновите в браузере страницу просмотра (сервер &#171;'.$videoserv.'&#187; перезапускать не нужно).';
...
$DEV_FIRMS='&copy; 2007-2010 ООО &#171;Сетевые информационные системы&#187;';
?>
