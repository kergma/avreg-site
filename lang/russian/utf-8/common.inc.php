...
'<ul>'.
'<li>Чтобы не настраивать одни и те же параметры для каждой камеры, определите их для всех камер разом по ссылке &#171;<a href="'.$conf['prefix'].'/admin/cam-tune.php?cam_nr=0">параметры&nbsp;для&nbsp;всех</a>&#187;.</li>'.
...
'Для просмотра архива вы должны иметь хотя бы одну настроенную видеокамеру.<br> '.
'Попросите настроить видеокамеры установщика или администратора системы.';
...
$strNotWcReason = 'Причина, почему недоступна для локального просмотра';
