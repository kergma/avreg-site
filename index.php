...
if ($admin_user /* config.inc.php */) {
    ...
    print  '<div style="position:relative;" ><div class="mode_item" style="position:absolute; " >' . "\n";
    print '<a class="main_links" href="' . $href3 . '" title="' . $a_adminv . '"><img   src="./img/admin.jpg"
        width="251" height="165" border="0"></a>' . "\n";
...
if ($arch_user) {
    ...
    print '<td align="center" valign="top" class="main_td_ref" >' . "\n";
    print  '<div style="position:relative;" ><div class="mode_item" style="position:absolute; " >' . "\n";
    print '<a class="main_links" href="./offline/index.php" title="' . $a_archive . '"><img   src="./img/offline.jpg"
        width="251" height="165" border="0"></a>' . "\n";
    ...
    print '<td align="center" valign="top" class="main_td_ref" >' . "\n";
    print  '<div style="position:relative;" ><div class="mode_item" style="position:absolute; " >' . "\n";
    print '<a class="main_links" href="./offline/playlist.php"><img   src="./img/offline_playlist.jpg"
        width="251" height="165" border="0"></a>' . "\n";
    ...
    print '<td align="center" valign="top" class="main_td_ref" >' . "\n";
    print  '<div style="position:relative;" ><div class="mode_item" style="position:absolute; " >' . "\n";
    print '<a class="main_links" href="./offline/gallery.php"><img src="./img/offline_gallery.png"
        width="251" height="165" border="0"></a>' . "\n";
